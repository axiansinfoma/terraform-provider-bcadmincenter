...
func TestBCAdminCenterProvider_Resources(t *testing.T) {
	...
	// We should have 7 resources: authorized_entra_app, environment, environment_update_schedule, environment_app, environment_settings, support_contact, notification_recipient.
	expectedCount := 7
