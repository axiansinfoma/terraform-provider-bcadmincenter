...
func TestBCAdminCenterProvider_Resources(t *testing.T) {
	...
	// We should have 7 resources: authorized_entra_app, environment, environment_update_schedule, environment_app, support_contact, notification_recipient, per_tenant_extension.
	expectedCount := 7
...
func TestBCAdminCenterProvider_DataSources(t *testing.T) {
	...
	// We should have 11 data sources: authorized_entra_apps, manageable_tenants, available_applications, application_family, environment, environments, environment_updates, notification_settings, scheduled_pte_operations, quotas, timezones.
	expectedCount := 11
