...
2. **[Workload Identity Federation](https://github.com/vllni/terraform-provider-bcadmincenter/blob/main/tutorials/workload-identity-github.md)** - Recommended for CI/CD (authenticates via OIDC against an Azure AD app registration with federated credentials)
