---
page_title: "Guide: Authenticating using Azure CLI"
subcategory: "Authentication"
description: |-
  This guide demonstrates how to authenticate the Business Central Admin Center provider using Azure CLI credentials. This method is ideal for local development and interactive scenarios.
---
