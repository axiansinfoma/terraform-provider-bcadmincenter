---
page_title: "Guide: Authenticating using a Managed Identity"
subcategory: "Authentication"
description: |-
  This guide demonstrates how to authenticate the Business Central Admin Center provider using Azure Managed Identity. This method is ideal for Terraform running on Azure compute resources like Virtual Machines, Container Instances, or App Service.
---
