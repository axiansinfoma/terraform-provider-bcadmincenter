---
page_title: "Guide: Authenticating using Workload Identity in Azure DevOps"
subcategory: "Authentication"
description: |-
  This guide demonstrates how to authenticate the Business Central Admin Center provider in Azure DevOps using Azure AD Workload Identity Federation with a service connection. This secure approach eliminates the need to store client secrets in Azure DevOps.
---
