---
page_title: "Guide: Multi-Tenant Management"
subcategory: "Getting Started"
description: |-
  This guide shows how to manage Business Central environments across multiple tenants using the Business Central Admin Center Terraform provider.
---
...
- [`bcadmincenter_manageable_tenants` data source](../data-sources/manageable_tenants.md) – full attribute reference
- [`bcadmincenter_environment` resource](../resources/environment.md) – full attribute reference
